...
PROCEDURE alias:
    ...
    IF (ENTRY(3, cPrm, '|') EQ '1') THEN
        CREATE ALIAS VALUE(ENTRY(1, cPrm, '|')) FOR DATABASE VALUE(ENTRY(2, cPrm, '|')).
    ELSE
        CREATE ALIAS VALUE(ENTRY(1, cPrm, '|')) FOR DATABASE VALUE(ENTRY(2, cPrm, '|')) NO-ERROR.
    ASSIGN opOk = TRUE.
