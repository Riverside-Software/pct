...
public class ABLDuckTest extends BuildFileTestNg {
    ...
    public void check2EnumMetadata() throws IOException {
        ...
        assertEquals(js.members.get(3).comment, "<p>Comment LukeSkywalker</p>\n<h3>Definition:</h3>\n<p><code>LukeSkywalker = Padme, AnakinSkywalker</code></p>\n");
    ...
    public void check2TempTableMetadata() throws IOException {
        ...
        assertEquals(js.members.get(2).definition, "DEFINE TEMP-TABLE ttSample2 NO-UNDO <br>&nbsp;&nbsp;&nbsp;&nbsp;  FIELD champ1 AS CHARACTER<br>&nbsp;&nbsp;&nbsp;&nbsp;  FIELD champ2 AS CHARACTER EXTENT 2<br>&nbsp;&nbsp;&nbsp;&nbsp;  FIELD champ3 AS CHARACTER FORMAT X(3)<br>&nbsp;&nbsp;&nbsp;&nbsp;  FIELD champ4 AS CHARACTER EXTENT 4 FORMAT X(3)<br>&nbsp;&nbsp;&nbsp;&nbsp;  INDEX i1 PRIMARY UNIQUE champ1<br>&nbsp;&nbsp;&nbsp;&nbsp;");
    ...
    public void check2PropertyMetadata() throws IOException {
        ...
        assertEquals(js.members.get(2).comment,"<h3>Purpose:</h3>\n<p>Purpose of property3</p>\n<h3>Notes:</h3>\n<p>Note of property3</p>\n");
        assertEquals(js.members.get(3).comment,"<h2>Purpose</h2>\n<p>The purpose of the property4</p>\n");
        assertEquals(js.members.get(4).comment,"<h2>Purpose</h2>\n<p>The purpose of the property5</p>\n");
        ...
        assertEquals(js.members.get(6).comment,"<h3>Purpose:</h3>\n<p>Purpose of property7</p>\n<h3>Notes:</h3>\n<p>Note of property7</p>\n");
        assertEquals(js.members.get(6).meta.isInternal , Boolean.TRUE);
        assertEquals(js.members.get(6).meta.isDeprecated.version , "0.0.1");
        assertEquals(js.members.get(7).comment,"<h3>Modifier:</h3>\n<p><code>GET - PROTECTED SET</code></p>\n");
        assertEquals(js.members.get(8).comment,"<h3>Modifier:</h3>\n<p><code>GET</code></p>\n");
        assertEquals(js.members.get(9).comment,"<p>Simple comment for property10</p>\n<h3>Modifier:</h3>\n<p><code>PROTECTED GET - SET</code></p>\n");
        assertEquals(js.members.get(10).comment,"<p>Simple comment for property11</p>\n<h3>Modifier:</h3>\n<p><code>SET</code></p>\n");
        assertEquals(js.members.get(11).comment,"<h2>Purpose</h2>\n<p>The purpose of the property12</p>\n<h3>Modifier:</h3>\n<p><code>PRIVATE GET - SET</code></p>\n");
     
    }
    
    @Test(groups = {"v11"}, enabled = false, dependsOnMethods = {"test2GenerateDocs"})
