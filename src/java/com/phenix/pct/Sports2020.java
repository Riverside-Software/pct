...
/**
 * Class for creating a sports2020 database
 * 
 * @author <a href="mailto:g.querret+PCT@gmail.com">Gilles QUERRET </a>
 */
public class Sports2020 extends PCT {
    ...
    public void execute() {
        ...
        // If dbName is null, then it's sports2020
        if (dbName == null) {
            dbName = "sports2020"; //$NON-NLS-1$
        }
    ...
    /**
     * Creates the _dbutil procopy sports2020 command line
     * 
    ...
    private ExecTask initCmdLine() {
        ...
        exec.createArg().setValue(new File(getDlcHome(), "sports2020").getAbsolutePath()); //$NON-NLS-1$
