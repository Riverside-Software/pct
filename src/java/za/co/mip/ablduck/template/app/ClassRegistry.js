...
Ext.define("Docs.ClassRegistry", {
    ...
    search: function(text, guides) {
        ...
        var nSort = 5;
        // which is *4 by it being public/deprecated/private,
        var nVisib = 4;
        ...
        for (var i=0, len=searchData.length; i<len; i++) {
            ...
            // Order items by visibility: public, deprecated, private
            var visibility = r.meta["internal"] ? adjInt : (r.meta["private"] ? adjPri : (r.meta["deprecated"] ? adjDep : adjPub));
